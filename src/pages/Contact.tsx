          ...
          <div>
            <div className="bg-white rounded-2xl shadow-sm p-8 h-full">
              ...
              <div className="space-y-8">
                <div className="flex">
                  <div className="flex-shrink-0 w-12 h-12 bg-nurmaa-mint rounded-full flex items-center justify-center mr-4">
                    <svg 
                      className="h-6 w-6 text-nurmaa-green" 
                      fill="none" 
                      viewBox="0 0 24 24" 
                      stroke="currentColor"
                    >
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      <a href="mailto:deepacse51@gmail.com" className="hover:text-nurmaa-green">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="w-10 h-10 bg-nurmaa-green bg-opacity-10 rounded-full flex items-center justify-center text-nurmaa-green hover:bg-nurmaa-green hover:text-white transition-colors"
                    aria-label="Facebook"
                  >
